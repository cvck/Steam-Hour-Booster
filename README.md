Python script to farm Steam playtime hours 

I've been using this for awhile and it still works fine. so ill be posting here for now 
...
Discord: https://discord.gg/cfjwX7gghV

**Disclaimer**

This is a personal tool made for fun.
I'm not responsible if Steam decides to take action against accounts using it. (no known bans from anyone using tools like this)
Use responsibly and only on accounts you don't mind risking.
