...
╚════════════════════════════════════════════════════╝
""" + RESET)
    print(CYAN + "  https://discord.gg/uR87Cq36gd  " + RESET)
    print()
    if logged_user:
...
class MySteamFarmer:  
    ...
    def login_account(self, stay_offline=False):
    ...
    def check_game_details(self, app_ids):  
        print("\n" + CYAN + "="*60 + RESET)
    ...
    def start_boost(self, app_ids, game_info, hours):  
